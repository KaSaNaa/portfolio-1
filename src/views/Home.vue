...
function hookLoops() {
    ...
    scenes[12].on('enter', (e) => {
        // add bg just in case in both directions
        document.body.classList.add('-mario-bg')
    })
    scenes[13].on('enter', (e) => {
        // add bg just in case in both directions
        document.body.classList.add('-mario-bg')
    })
    scenes[14].on('enter', (e) => {
        // add bg just in case in both directions
        document.body.classList.add('-mario-bg')
    })
    scenes[15]
...
function sceneFloatingHead() {
    // first company
    timeLines[7].addLabel('start', 0)
}
...
function sceneMario() {
    ...
    timeLines[10].set('.mario', { yPercent: 200, autoAlpha: 0 })
}

function sceneGhibli() {
    ...
    // Ghibli 2 (gap)
    timeLines[12].addLabel('start', 0)

    // Ghibli 3 (gap)
    timeLines[13].addLabel('start', 0)

    // Ghibli 4 (gap)
    timeLines[14].addLabel('start', 0)
}
